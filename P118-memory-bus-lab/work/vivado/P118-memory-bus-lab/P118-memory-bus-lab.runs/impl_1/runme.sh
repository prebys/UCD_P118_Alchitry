...
HD_PWD='C:/Users/ericp/github/UCD_P118_Alchitry/P118-memory-bus-lab/work/vivado/P118-memory-bus-lab/P118-memory-bus-lab.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log au_top_0.vdi -applog -m64 -messageDb vivado.pb -mode batch -source au_top_0.tcl -notrace
