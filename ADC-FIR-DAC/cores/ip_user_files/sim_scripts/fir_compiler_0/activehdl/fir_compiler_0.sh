...
#
# Script generated by Vivado on Fri Feb 16 10:06:15 -0800 2024
...
map_setup_file()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="C:/Users/ericp/github/UCD_P118_Alchitry/ADC-FIR-DAC/cores/managed_ip_project/managed_ip_project.cache/compile_simlib/activehdl"
  fi
  if [[ ($lib_map_path != "") ]]; then
